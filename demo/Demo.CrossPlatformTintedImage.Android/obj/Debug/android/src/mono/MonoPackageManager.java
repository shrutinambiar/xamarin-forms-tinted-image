...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Demo.CrossPlatformTintedImage.Android.dll" comes first in this list. */
		"Demo.CrossPlatformTintedImage.Android.dll",
		"Demo.CrossPlatformTintedImage.dll",
		"FormsViewGroup.dll",
